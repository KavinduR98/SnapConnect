...
import comment from "../../assets/images/comment_01.png";
...
const PostCard = ({ uid, id, logo, name, text, image, timestamp }) => {
      ...
      <div className="flex flex-col py-4 bg-white rounded-t-3xl">
        ...
        <div className="flex justify-around items-center pt-4">
          ...
          <button
            ...
            onClick={handleLike}
          >
            <img className="h-8 mr-1" src={like} alt=""></img>
          ...
          >
            <div className="flex items-center cursor-pointer">
              <img className="h-8 mr-1" src={comment} alt="comment"></img>
            </div>
          </div>
          ...
          <div
            ...
            onClick={deletePost}
          >
            <img className="h-8 mr-1" src={remove} alt="delete"></img>
          </div>
        </div>
      </div>
